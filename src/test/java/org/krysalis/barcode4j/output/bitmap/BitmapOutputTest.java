...
public class BitmapOutputTest extends TestCase {
	...
	public BitmapOutputTest(final String name) {
		super(name);
	}

	private BarcodeGenerator getGenerator() throws BarcodeException, ConfigurationException {

		BarcodeUtil util = BarcodeUtil.getInstance();
		BarcodeGenerator gen = util.createBarcodeGenerator("intl2of5");
		return gen;
	}
