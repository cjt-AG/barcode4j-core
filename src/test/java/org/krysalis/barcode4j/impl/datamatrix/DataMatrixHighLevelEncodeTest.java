...
public class DataMatrixHighLevelEncodeTest extends TestCase {
	...
	private static String createBinaryMessage(final int len) {
	...
	private void assertEndsWith(final String expected, final String actual) {
	...
	private String encodeHighLevel(final String msg) throws IOException {
