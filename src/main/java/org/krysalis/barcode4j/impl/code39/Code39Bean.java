...
public class Code39Bean extends AbstractBarcodeBean {
	 ...
	 */
	public void setIntercharGapWidth(final double width) {
	 ...
	 *
	 * @param value
	 *            the wide factory (should be > 1.0)
	 */
	public void setWideFactor(final double value) {
		if (value <= 1.0) {
	 ...
	 *
	 * @param value
	 *            true to enable the start/stop character, false to disable
	 */
	public void setDisplayStartStop(final boolean value) {
	 ...
	 *
	 * @param value
	 *            true to include the checksum in the human-readable message, false to ignore
	 */
	public void setDisplayChecksum(final boolean value) {
	 ...
	 *
	 * @param value
	 *            true to enable the extended character set
	 */
	public void setExtendedCharSetEnabled(final boolean value) {
		this.extendedCharSet = value;
	}

	/** {@inheritDoc} */
	@Override
	public double getBarWidth(final int width) {
		if (width == 1) {
			return moduleWidth;
		} else if (width == 2) {
