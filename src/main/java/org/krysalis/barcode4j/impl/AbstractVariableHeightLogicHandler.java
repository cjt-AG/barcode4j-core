...
public abstract class AbstractVariableHeightLogicHandler implements ClassicBarcodeLogicHandler {
	 ...
	 */
	public AbstractVariableHeightLogicHandler(final HeightVariableBarcodeBean bcBean, final Canvas canvas) {
		this.bcBean = bcBean;
		this.canvas = canvas;
	}
	...
	/** {@inheritDoc} */
	@Override
	public void startBarcode(final String msg, final String formattedMsgParam) {
		this.formattedMsg = MessagePatternUtil.applyCustomMessagePattern(formattedMsgParam, bcBean.getPattern());
		// Calculate extents
	...
	/** {@inheritDoc} */
	@Override
	public void startBarGroup(final BarGroup barGroup, final String string) {
	}
