...
public class EAN128Bean extends Code128Bean {
	 ...
	 * <p>
	 * The format of the templates here is a repeating set of AI number (in brackets) followed by a field description. The allowed data
	 * types are "n" (numeric), "an" (alpha-numeric), "d" (date) and "cd" (check digit). Examples: "n13" defines a numeric field with
	 * exactly 13 digits. "n13+cd" defines a numeric field with exactly 13 digits plus a check digit. "an1-9" defines an alpha-numeric field
	 * with 1 to 9 characters.
	 *
	 * @param string
	 *            a template like "(01)n13+cd(421)n3+an1-9(10)an1-20"
	 */
	 ...
	 *
	 * @param c
	 *            the character for the check digit marker
	 */
