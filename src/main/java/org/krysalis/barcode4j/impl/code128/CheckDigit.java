...
public class CheckDigit {
	...
	public static char calcCheckdigit(final String msg, final int start, final int end, final byte type) {
		switch (type) {
		case CD31:
	...
	public static char calcCheckdigit31(final String msg, final int start, final int end) {
		return calcCheckdigit(3, 1, msg, start, end);
	}

	public static char calcCheckdigit11(final String msg, final int start, final int end) {
		return calcCheckdigit(1, 1, msg, start, end);
	}

	public static char calcCheckdigit(final int oddMult, final int evenMult, final String msg, final int start, final int end) {
		int oddSum = 0;
		int evenSum = 0;
		boolean even = false;
