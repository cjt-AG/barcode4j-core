...
public abstract class AbstractBarcodeBean implements BarcodeGenerator {
	...
	/**
	 * Indicates whether the barcode height calculation should take a font descender into account. This is necessary for barcodes that
	 * support lower-case characters like Code128.
	 *
	 ...
	 */
	public void setModuleWidth(final double width) {
	 ...
	 */
	public void doQuietZone(final boolean value) {
	...
	/**
	 * Returns the vertical quiet zone. If no vertical quiet zone is set explicitely, the value if {@link #getQuietZone()} is returned.
	 *
	 ...
	 */
	public void setQuietZone(final double width) {
		this.quietZone = width;
	}

	/**
	 * Sets the height of the vertical quiet zone. If this value is not explicitely set the vertical quiet zone has the same width as the
	 * horizontal quiet zone.
	 *
	 * @param height
	 *            the height of the vertical quiet zone (in mm)
	 */
	public void setVerticalQuietZone(final double height) {
		this.quietZoneVertical = Double.valueOf(height);
	}
	 ...
	 */
	public void setMsgPosition(final HumanReadablePlacement placement) {
